                    ...
                    <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-body pd-20 pd-md-40 border shadow-none">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="name" id="productName" type="text" placeholder="Enter Product Name" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="price" id="productPrice" type="number" placeholder="Enter Product Price" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label" >Product Description</label>
                                <textarea rows="5" class="form-control" name="description" placeholder="Enter Product Description" required></textarea>
                            </div>
