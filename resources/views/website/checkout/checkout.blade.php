                                                ...
                                                <div class="payment-option-wrapper">
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-1">
                                                            <img src="{{ asset('website-assets') }}/assets/images/shipping/shipping-1.png" alt="Sipping">
                                                    ...
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-2">
                                                            <img src="{{ asset('website-assets') }}/assets/images/shipping/shipping-2.png" alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    </div>
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-3">
                                                            <img src="{{ asset('website-assets') }}/assets/images/shipping/shipping-3.png" alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    </div>
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-4">
                                                            <img src="{{ asset('website-assets') }}/assets/images/shipping/shipping-4.png" alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="checkout-payment-form">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        ...
                                                        <img src="{{ asset('website-assets') }}/assets/images/payment/card.png" alt="card">
                                                    </div>
                                                </div>
